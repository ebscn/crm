...
#  {:name => 'contacts_index_table', :title => 'Table format', :icon => 'fa-table',
#   :controllers => ['contacts'], :actions => ['index'], :template => 'contacts/index_table'},
 ...
 {:name => 'accounts_index_table', :title => 'Table format', :icon => 'fa-table',
   :controllers => ['accounts'], :actions => ['index'], :template => 'accounts/index_table'},
